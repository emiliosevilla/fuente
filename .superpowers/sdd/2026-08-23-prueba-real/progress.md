...
- No se hizo push ni despliegue. La auditoría y sus reconciliaciones quedaron registradas en commits; `dist/` permanece fuera del alcance y no se trata como `DEPLOYED`.
