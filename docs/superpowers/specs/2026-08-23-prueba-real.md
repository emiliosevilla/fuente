...
Estado activo inicial de la campaña: todas las fases estaban `NOT_RUN`. Estado actual: PR-00, PR-04 y PR-05 tienen `S PASS`, `R PASS` y están `COMPLETE`; PR-06 y PR-07 tienen `S PASS`, `R NOT_RUN` y están `PARTIAL`; las fases posteriores siguen `NOT_RUN`. El orden obligatorio es: PR-00, PR-04, PR-05, PR-06, PR-07, PR-01, PR-03, PR-08, PR-09, PR-10, PR-11, PR-02, PR-12. Cada fase ejecuta primero `S` sintética y sólo si pasa ejecuta `R` real.

`PR-10` repite su prueba sintética y no hereda automáticamente el bloqueo histórico por IDs duplicados. En el estado actual PR-00, PR-04 y PR-05 están `COMPLETE`; PR-06 y PR-07 están `PARTIAL` (`S PASS`, `R NOT_RUN`); PR-01, PR-03 y PR-08+ están `NOT_RUN`.
