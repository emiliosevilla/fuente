"""
Fuente Category Modal — Sub-ventana modal nativa Papiro para desgloses estadísticos por categoría.
...
class FuenteCategoryModal(tk.Toplevel):
    """
    ...
    def __init__(self, parent: tk.Widget, category_title: str, file_paths: List[Path]):
        ...
        self.title(f"Fuente — Desglose: {category_title}")
