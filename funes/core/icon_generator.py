...
def ensure_app_icon(assets_dir: Path) -> Path:
    """Asegura la presencia del icono oficial de alta definición Funes en assets/."""
    assets_dir.mkdir(parents=True, exist_ok=True)
    icon_png = assets_dir / "funes_icon.png"
    icon_ico = assets_dir / "funes_icon.ico"
...
def ensure_archive_icon(assets_dir: Path) -> Path:
    """Genera el icono estilo 'archivador' para 'La Memoria de Funes'."""
    assets_dir.mkdir(parents=True, exist_ok=True)
