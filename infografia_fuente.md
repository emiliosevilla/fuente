# 🧠 Fuente: Infografía Explicativa del Sistema
...
Fuente opera mediante un pipeline de extracción, transformación y carga (ETL) continuo e incremental de 4 fases que procesa archivos desestructurados en bruto y los convierte en notas atómicas interconectadas en **Obsidian**.
...
flowchart TD
    ...
    subgraph GOBERNANZA ["4. Persistencia y Control"]
        A -->|Vectores de contexto| C["🗄️ .fuente/ChromaDB"]
        W -->|Errores / Incompatibles| Q["⚠️ .fuente/quarantine/"]
    end
...
Fuente procesa automáticamente cualquier tipo de documento convirtiéndolo a texto limpio sin alterar los archivos originales.
...
> [!IMPORTANT]
> **Fuente está diseñado para resistir las peculiaridades de los sistemas de archivos reales:**
...
> - **Aislamiento en Cuarentena**: Archivos dañados o no procesables se trasladan a `.fuente/quarantine/` sin interrumpir la ingesta del resto del volumen.
...
| **⚡ 1-Clic Launch** | Lanzadores automáticos para macOS (`instalar_fuente.command`) y Windows (`instalar_fuente.bat`). |
